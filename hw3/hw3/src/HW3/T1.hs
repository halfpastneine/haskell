...
mapTree _ Leaf                 = Leaf
mapTree f (Branch Leaf h Leaf) = Branch Leaf (f h) Leaf
mapTree f (Branch l h Leaf)    = Branch (mapTree f l) (f h) Leaf
mapTree f (Branch Leaf h r)    = Branch Leaf (f h) (mapTree f r)
